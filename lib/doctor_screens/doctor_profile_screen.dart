  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        stream: FirebaseFirestore.instance.collection('Doctors').doc(getPhone()).snapshots(),
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                _buildProfileCard(Icons.medical_services, "Specialization", data['Specialization']),
                _buildProfileCard(Icons.local_hospital, "Hospital Name", data['Hospital']),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => EditDoctorProfileScreen(userId: getPhone())),
                      );
                    },
          ...
          child: CircleAvatar(
            ...
            child: ClipOval(
              child: Image.asset(
                "assets/logo.jpeg",
                fit: BoxFit.cover,
                width: 130, // Ensure width matches CircleAvatar
                height: 130,
              ),
            ),
          ),
